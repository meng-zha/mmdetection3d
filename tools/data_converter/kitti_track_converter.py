...
from .kitti_track_data_utils import get_kitti_track_image_info
...
def create_kitti_track_info_file(data_path,
    ...
    kitti_infos_train = get_kitti_track_image_info(
        data_path,
        training=True,
        velodyne=True,
        calib=True,
    ...
    kitti_infos_val = get_kitti_track_image_info(
        data_path,
        training=True,
        velodyne=True,
        calib=True,
    ...
    kitti_infos_test = get_kitti_track_image_info(
        data_path,
        training=False,
        label_info=False,
        velodyne=True,
        calib=True,
        scene_ids=test_img_ids,
        relative_path=relative_path)
