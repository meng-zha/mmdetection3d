...
class PointNet2SAMSGFP(BasePointNet):
    ...
    def __init__(self,
        ...
        fp_source_channel = aggregation_channels[-1]
        for fp_index in range(len(fp_channels)):
            if fp_index != len(fp_channels) - 1:
                fp_target_channel = aggregation_channels[-2-fp_index]
            else:
                fp_target_channel = in_channels-3
