...
from mmdet3d.models.model_utils import VoteModule, vote_module
...
class R3DVoteHead(nn.Module):
    ...
    def __init__(self,
                 ...
                 semantic_loss=None,
                 iou_loss=None):
        super(R3DVoteHead, self).__init__()
    ...
    def forward(self, feat_dict, sample_mod, hidden_dict):
        """Forward pass.
